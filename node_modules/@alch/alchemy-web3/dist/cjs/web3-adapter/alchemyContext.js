...
function makeAlchemyContext(url, config) {
    ...
    if (/^https?:\/\//.test(url)) {
        ...
        var _a = sendPayload_1.makePayloadSender(alchemySend, config, makePayload), sendPayload = _a.sendPayload, setWriteProvider = _a.setWriteProvider;
        ...
        var _b = sendPayload_1.makePayloadSender(alchemySend, config, makePayload), sendPayload = _b.sendPayload, setWriteProvider = _b.setWriteProvider;
        var senders = jsonRpc_1.makeSenders(sendPayload, makePayload);
